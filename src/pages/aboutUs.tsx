            ...
            <div className='w-[80%] m-auto'>
                ...
                <div className='flex gap-20'>
                    ...
                    <div className='ml-40'>
                        ...
                        <p className='text-center pl-40 pb-20'>Vie et Environnement Rwanda (VER) is Non-Government Organization, registration no 14/NGO/RGB/2016;
                ...
                <div className='mt-40 flex gap-10'>
                    <div className='bg-white border-2  border-s-[#fe7f4c]  h-[18rem] w-[22rem] p-2 rounded-md shadow-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300'>
                    ...
                    <div className='bg-white border-2  border-s-[#fe7f4c]  h-[18rem] w-[24rem] p-2 rounded-md shadow-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300'>
                        <div className='flex justify-between p-2' >
