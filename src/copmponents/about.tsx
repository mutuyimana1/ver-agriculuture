    ...
    return (
        <div className='text-black w-full p-5'>
            ...
            <div className='flex gap-10 w-[80%] m-auto'>
                <div className='bg-white h-[20rem] w-[23rem] p-2 rounded-md shadow-md transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300'>
...
<div className='w-[80%] m-auto grid grid-cols-5 gap-x-5'>
